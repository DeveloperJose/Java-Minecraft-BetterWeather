...
public abstract class BWeatherType {
    ...
    public static BWeatherType LIGHT_WIND_LIGHT_RAIN = new CombinedBWeatherType(LIGHT_WIND, LIGHT_RAIN);
    public static BWeatherType HEAVY_WIND_LIGHT_RAIN = new CombinedBWeatherType(HEAVY_WIND, LIGHT_RAIN);
    public static BWeatherType HEAVY_WIND_HEAVY_RAIN = new CombinedBWeatherType(HEAVY_WIND, HEAVY_RAIN); // Alias: Thunderstorm

    public static BWeatherType LIGHT_WIND_LIGHT_SNOW = new CombinedBWeatherType(LIGHT_WIND, LIGHT_SNOW);
    public static BWeatherType HEAVY_WIND_HEAVY_SNOW = new CombinedBWeatherType(HEAVY_WIND, HEAVY_SNOW); // Alias: Blizzard

    public static final BWeatherType[] ALL_TYPES = new BWeatherType[]{CLEAR, LIGHT_RAIN, LIGHT_WIND, HAIL};
    public static final BWeatherType[] AFTER_HAIL = new BWeatherType[]{CLEAR,};

    public static BWeatherType weatherFromString(String weatherName) {
